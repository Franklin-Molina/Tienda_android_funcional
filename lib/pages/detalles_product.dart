...
void deletProduct(){
  var url="http://192.168.0.118/tienda/deletProduct.php";
  http.post(url, body: {
...
void confirm (){
  AlertDialog alertDialog = new AlertDialog(
    content: new Text("Esta seguro de eliminar '${widget.listPrd[widget.indexProd]['nombre']}'"),
    actions: <Widget>[
      new RaisedButton(
            ...
            child: new Center(
              child: new Column(
                children: <Widget>[
                  ...
                  new Text(widget.listPrd[widget.indexProd]['nombre'], style: new TextStyle(fontSize: 20.0),),
                  Divider(),
                 ...
                 new Row(
                    ...
                    children: <Widget>[
                      ...
                      onPressed: ()=>Navigator.of(context).push(
                          new MaterialPageRoute(
                           builder: (BuildContext context)=>new EditDetalles(list: widget.listPrd, index: widget.indexProd,),
                          )
                        ),                    
                    ),
                    VerticalDivider(),
